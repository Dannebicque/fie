...
class DiplomeController extends AbstractController
{
    ...
    {
        return $this->render('diplome/index.html.twig', ['diplomes' => $diplomeRepository->findAll()]);
    }
    ...
    {
        return $this->render('diplome/show.html.twig', ['diplome' => $diplome]);
    }
    ...
    public function edit(Request $request, Diplome $diplome): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('diplome_edit', ['id' => $diplome->getId()]);
        }
